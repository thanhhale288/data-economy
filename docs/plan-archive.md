<!-- ARCHIVE: historical full plan. Agents: prefer docs/plan.md (hot). -->
...
**Tracking task chi tiết Epic 4:** xem mục `Task breakdown` trong [`.scratch/epic4-ai-ml-plan.md`](../.scratch/epic4-ai-ml-plan.md).
