...
| **4 — Web hoàn thiện** | **Đang làm** | Task #13–#15 DONE trên nhánh Phase 4; còn #16–#17 |
...
**Git:** Phase 1 + Phase 2 trên `origin/main` (PR #1, PR #2). Phase 3: `cursor/phase3-clean-features-ml` → PR #5 (OPEN). Phase 4: Task #13 PR #6; Task #14 PR #7; Task #15 `cursor/phase4-task15-pipeline-monitor` (base tip Task #14).
